...
<!-- card -->
<?php echo form_open_multipart('users/save', [ 'class' => 'needs-validation', 'novalidate' => '', 'autocomplete' => 'off' ]); ?>
<div class="card">
  <div class="card-body">
    <h4 class="card-title">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nama" id="nama" onkeyup="$('#formClient-Username').val(createUsername(this.value))" placeholder="Nama Lengkap" autofocus required >
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="telp" id="telp" placeholder="Nomor HP / Telephone" >
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-sm-3 col-form-label">Email</label>
          <div class="col-sm-9">
            <input type="email" class="form-control" name="email" id="email" placeholder="Email" data-rule-remote="<?php echo url('users/check') ?>" data-msg-remote="Email sudah digunakan!" required >
            <div class="invalid-feedback">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <textarea rows="2" class="form-control" name="alamat" id="alamat" placeholder="Alamat Lengkap" required ></textarea>
            <div class="invalid-feedback">
              Alamat harus diisi!
            </div>
          </div>
      ...
      <div class="col-sm-6">
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="username" id="formClient-Username" data-rule-remote="<?php echo url('users/check') ?>" data-msg-remote="Username sudah digunakan!" placeholder="Username" required >
            <div class="invalid-feedback">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            ...
            <div class="invalid-feedback" id="status_password_konfirmasi">
...
<script>
  ...
  $(document).ready(function () {
    $("#password_konfirmasi").on('keyup', function(){
      var password        = $("#password").val();
      var confirmPassword = $("#password_konfirmasi").val();
      if (password != confirmPassword) {
        $("#status_password_konfirmasi").show();
      } else {
        $("#status_password_konfirmasi").hide();
      }
    });
  });
</script>
