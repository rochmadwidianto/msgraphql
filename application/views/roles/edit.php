...
<!-- card -->
<?php echo form_open_multipart('roles/update/'.encrypt_url($role->id), [ 'class' => 'needs-validation', 'novalidate' => '' ]); ?>
<div class="card">
  <div class="card-body">
    <h4 class="card-title">
      ...
      <tbody>
        ...
        <tr class='<?php echo $row_class; ?>' style='<?php echo $row_style; ?>'>
          ...
          <td class="text-center">
            ...
            ?>
            <div class="form-check form-check-success">
              <input class="form-check-input check-select-p" type="checkbox" id="cbxAccessList" name="permission[]" value="<?php echo $row->code ?>" <?php echo $isChecked ?>>
              <label class="form-check-label" for="cbxAccess">&nbsp;</label>
            </div>
          </td>
        </tr>
